...
figure(11),clf
plot(0,0,'ko','linewidth',2)
hold on,plot([1 0],[0 0],'k-') % tracer le segment de droite permettant de 
...
title('Dix individus de taille 1 suivant une distribution uniforme');
...
title('Dix individus de taille 2 suivant une distribution gaussiene de moyenne 0 et d ecart type 1 ');
...
grid on ;
legend('individus','element moyen');
title('Dix individus de taille 3 suivant une distribution gaussienne de moyenne 2 et d ecart type 3 ');
